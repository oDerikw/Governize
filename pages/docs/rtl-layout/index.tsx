...
function RtlLayout() {
  ...
  return (
    <>
      <Head>
        <title>
          Right-to-Left Layout - Tokyo White NextJS Typescript Admin Dashboard
        </title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo White NextJS Typescript Admin Dashboard fully supports
            ...
            <Typography paragraph>
              ...
              <code>src\theme\schemes\PureLightTheme.ts</code>) you will
